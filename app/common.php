...
$categorie = array(
1 => "Non défini",
2 => "Objet ou vehicule bloquant le passage (GCUM, ...)",
3 => "Aménagement incohérent",
4 => "Entretien de voirie (nid de poule, ...)",
5 => "Zone sans stationnement vélo",
6 => "Coupure temporaire sans balisage (chantier, ...)",
7 => "Incivilité récurrente sur la route (SAS velos encombré, ...)",
