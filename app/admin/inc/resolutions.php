...
?>
   <a href="<?=$config['HTTP_PROTOCOL'] ?>://<?=$config['URLBASE'] ?>/get_photo.php?type=resolution&token=<?= $result_resolution['resolution_token'] ?>" target="_blank"><img width="200px" src="/get_photo.php?type=resolution&token=<?= $result_resolution['resolution_token'] ?>" /></a>
<?php
    } else {
?>
   Pas de photo
