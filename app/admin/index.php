...
$menu = [
  'dashboard' => ['icon' => 'home', 'name' => 'Accueil', 'access' => ['admin', 'citystaff']],
  'observations' => ['icon' => 'list', 'name' => 'Observations', 'access' => ['admin', 'citystaff']],
  'resolutions' => ['icon' => 'user-check', 'name' => 'Resolutions', 'access' => ['admin', 'citystaff']],
  'cities' => ['icon' => 'briefcase', 'name' => 'Villes', 'access' => ['admin']],
  'accounts' => ['icon' => 'users', 'name' => 'Comptes', 'access' => ['admin']],
  'scopes' => ['icon' => 'compass', 'name' => 'Scopes', 'access' => ['admin']],
  'twitter' => ['icon' => 'twitter', 'name' => 'Twitter', 'access' => ['admin']],
  'settings' => ['icon' => 'settings', 'name' => 'Configuration', 'access' => ['admin']],
  'update' => ['icon' => 'zap', 'name' => 'Mises à jour', 'access' => ['admin']]
];
...
<body>
  ...
  <div class="container-fluid">
    <div class="row">
      <nav id="sidebar-menu" class="col-md-2 d-none d-md-block bg-light sidebar collapse">
          ...
          <ul class="nav flex-column">
            ...
            foreach ($menu as $key => $item) {
              ...
              if (in_array($_SESSION['role'], $item['access'])) {
                ...
                echo '<a class="nav-link' . $classNav . '" href="?page=' . $key . '">';
