...
if (!isset($_POST['coordinates_lat']) || !isset($_POST['coordinates_lon']) || !isset($_POST['categorie']) || !isset($_POST['address']) || !isset($_POST['time']) || !isset($_POST['scope'])) {
...
if (empty($coordinates_lat) or empty($coordinates_lon) or empty($categorie) or empty($time) or empty($address)) {
...
if (!($coordinates_lat >= $result_scope['scope_coordinate_lat_min'] && $coordinates_lat <= $result_scope['scope_coordinate_lat_max'] && $coordinates_lon >= $result_scope['scope_coordinate_lon_min'] && $coordinates_lon <= $result_scope['scope_coordinate_lon_max'])) {
